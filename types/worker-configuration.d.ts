/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=dist/server/wrangler.json types/worker-configuration.d.ts` (hash: 883c398c8f96a048d3aca6a1faf0ec81)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "KEEPA_MONTHLY_COST_CENTS">> {}
}
