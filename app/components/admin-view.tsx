    ...
    <section className="view-section">
      ...
      <div className="admin-grid">
        ...
        <form className="admin-panel admin-form" onSubmit={addSource}>
          ...
          <div className="admin-form-pair"><label>Découverte<select name="discoveryStrategy" defaultValue="links"><option value="links">Liens de page</option><option value="sitemap" disabled>Sitemap · non disponible</option><option value="feed" disabled>Flux partenaire · non disponible</option><option value="api" disabled>API partenaire · non disponible</option></select></label><label>Taille catalogue estimée<input name="estimatedProductCount" type="number" min="1" max="100000000" placeholder="ex. 2400" /></label></div>
          ...
          <p className="admin-muted">Ajouter une page étend la couverture sans publier de prix immédiatement. Fnac, Carrefour, Leroy Merlin, Castorama, Conforama et Rue du Commerce nécessitent une autorisation de collecte ou un flux partenaire ; l’activation exige ensuite un contrôle récent réussi.</p>
